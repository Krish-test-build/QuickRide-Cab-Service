...
const ConfirmRide = ({ selectedVehicle = "UberGo", setConfirmRidePanel, setWaitForDriverPanel }) => {
  ...
  return (
    <div className="flex flex-col p-4">
      <h3 className='text-3xl font-semibold mb-3.5'>Confirm Your Ride</h3>
