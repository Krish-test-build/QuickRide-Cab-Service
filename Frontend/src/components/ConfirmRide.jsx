    ...
    <div className="flex flex-col p-4">
      ...
      <div className="w-full max-w-md relative">
        <button
          ...
          className="h-10 w-10 absolute -right-2 -top-13"
        >
        ...
        <img
          ...
          className={`${
            props.vehicleType === 'auto' ? 'ml-5 w-[85%]' : 'w-full'
          } h-auto my-4 rounded-lg`}
        />
