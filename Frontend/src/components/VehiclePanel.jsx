        ...
        <div>
            <h4 ref={props.vehiclePanelCloseRef} 
                ...
                <div onClick={()=>{
                    ...
                    <div className='w-1/2'>
                    <h4 className=' font-medium text-lg'>UberGo <span ><svg className='w-3.5 h-3.5 inline-flex align-baseline mr-0.5' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M2 22C2 17.5817 5.58172 14 10 14C14.4183 14 18 17.5817 18 22H2ZM10 13C6.685 13 4 10.315 4 7C4 3.685 6.685 1 10 1C13.315 1 16 3.685 16 7C16 10.315 13.315 13 10 13ZM17.3628 15.2332C20.4482 16.0217 22.7679 18.7235 22.9836 22H20C20 19.3902 19.0002 17.0139 17.3628 15.2332ZM15.3401 12.9569C16.9728 11.4922 18 9.36607 18 7C18 5.58266 17.6314 4.25141 16.9849 3.09687C19.2753 3.55397 21 5.57465 21 8C21 10.7625 18.7625 13 16 13C15.7763 13 15.556 12.9853 15.3401 12.9569Z"></path></svg>3</span></h4>
                    <h5 className=' font-medium text-base'>2 mins away </h5>
                    <p className=' font-normal text-xs text-gray-600'>Affordable, compact</p>
                    </div>
                    <h2 className='text-xl font-semibold p-3'>₹193.20</h2>
                </div>
                <div onClick={()=>{
                    ...
                    <h2 className='text-xl font-semibold p-3'>₹65.17</h2>
                </div>
                <div onClick={()=>{
                    ...
                    <h2 className='text-xl font-semibold p-3'>₹118.21</h2>
                </div>
              </div>
  )
}
